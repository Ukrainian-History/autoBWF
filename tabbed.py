...
class Ui_autoBWF(object):
    def setupUi(self, autoBWF):
        ...
        self.layoutWidget = QtWidgets.QWidget(self.xmpTab)
        self.layoutWidget.setGeometry(QtCore.QRect(21, 21, 971, 198))
        ...
        self.commentLabel_2 = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.descriptionText = QtWidgets.QPlainTextEdit(self.layoutWidget)
        ...
        self.sourceLabel_2 = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.rightsOwnerSelect = QtWidgets.QComboBox(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.creationDateLabel_4 = QtWidgets.QLabel(self.layoutWidget)
        self.creationDateLabel_4.setObjectName("creationDateLabel_4")
        self.horizontalLayout_13.addWidget(self.creationDateLabel_4)
        self.interviewerLine = QtWidgets.QLineEdit(self.layoutWidget)
        ...
        self.creationDateLabel_5 = QtWidgets.QLabel(self.layoutWidget)
        self.creationDateLabel_5.setObjectName("creationDateLabel_5")
        self.horizontalLayout_14.addWidget(self.creationDateLabel_5)
        self.intervieweeLine = QtWidgets.QLineEdit(self.layoutWidget)
