...
class Ui_autoBWF(object):
    def setupUi(self, autoBWF):
        ...
        self.widget = QtWidgets.QWidget(self.xmpTab)
        self.widget.setGeometry(QtCore.QRect(21, 21, 971, 198))
        ...
        self.commentLabel_2 = QtWidgets.QLabel(self.widget)
        ...
        self.descriptionText = QtWidgets.QPlainTextEdit(self.widget)
        ...
        self.sourceLabel_2 = QtWidgets.QLabel(self.widget)
        ...
        self.rightsOwnerSelect = QtWidgets.QComboBox(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
