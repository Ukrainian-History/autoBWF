...
def main():
    ...
    root.append(ET.Comment('Automatically generated by bwf2pbcore. DO NOT EDIT BY HAND.'))
    root.append(ET.Comment('To make changes, edit the internal metadata in {} and re-run bwf2pbcore'.format(infile)))
    ...
    instantiation = ET.SubElement(root, "pbcoreInstantiation")
    add_child(instantiation, "instantiationDuration", metadata["Duration"])
    add_child(instantiation, "instantiationLanguage", metadata["language"])

    add_child(root, "pbcoreAnnotation", metadata["ISRC"], {"annotationType": "source collection"})
