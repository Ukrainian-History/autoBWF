...
class Ui_autoBWF(object):
    def setupUi(self, autoBWF):
        ...
        autoBWF.resize(716, 629)
        self.gridLayout = QtWidgets.QGridLayout(autoBWF)
        ...
        self.label_6 = QtWidgets.QLabel(autoBWF)
        ...
        self.label = QtWidgets.QLabel(autoBWF)
        ...
        self.label_2 = QtWidgets.QLabel(autoBWF)
        ...
        self.label_16 = QtWidgets.QLabel(autoBWF)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_12, 2, 3, 1, 2)
        ...
        self.label_18 = QtWidgets.QLabel(autoBWF)
        ...
        self.gridLayout.addLayout(self.formLayout_17, 2, 5, 1, 1)
        ...
        self.label_4 = QtWidgets.QLabel(autoBWF)
        ...
        self.label_5 = QtWidgets.QLabel(autoBWF)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_4, 3, 5, 1, 1)
        self.deckSelect = QtWidgets.QComboBox(autoBWF)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.deckSelect, 4, 0, 1, 1)
        self.softwareSelect = QtWidgets.QComboBox(autoBWF)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.softwareSelect, 4, 1, 1, 2)
        ...
        self.label_11 = QtWidgets.QLabel(autoBWF)
        self.label_11.setObjectName("label_11")
        self.formLayout_9.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_11)
        self.codingHistoryText = QtWidgets.QPlainTextEdit(autoBWF)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_10, 4, 3, 4, 3)
        self.adcSelect = QtWidgets.QComboBox(autoBWF)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.adcSelect, 5, 0, 1, 1)
        self.mediaSelect = QtWidgets.QComboBox(autoBWF)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addWidget(self.mediaSelect, 5, 1, 1, 2)
        ...
        self.gridLayout.addLayout(self.formLayout_12, 6, 0, 1, 3)
        ...
        self.gridLayout.addLayout(self.formLayout_11, 7, 0, 1, 2)
        ...
        self.label_7 = QtWidgets.QLabel(autoBWF)
        self.label_7.setObjectName("label_7")
        self.formLayout_10.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_7)
        self.speedSelect = QtWidgets.QComboBox(autoBWF)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout.addLayout(self.formLayout_10, 7, 2, 1, 1)
        ...
        self.label_14 = QtWidgets.QLabel(autoBWF)
        self.label_14.setObjectName("label_14")
        self.formLayout_13.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_14)
        self.commentText = QtWidgets.QPlainTextEdit(autoBWF)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_8, 8, 4, 1, 2)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_9, 11, 0, 1, 6)
    ...
    def retranslateUi(self, autoBWF):
        ...
        self.label_6.setText(_translate("autoBWF", "Title"))
        self.label.setText(_translate("autoBWF", "Description"))
        self.label_2.setText(_translate("autoBWF", "Originator"))
        self.label_16.setText(_translate("autoBWF", "Creation Date"))
        self.label_18.setText(_translate("autoBWF", "Source"))
        self.label_4.setText(_translate("autoBWF", "OriginationDate"))
        self.label_5.setText(_translate("autoBWF", "OriginationTime"))
        self.label_3.setText(_translate("autoBWF", "OriginatorRef"))
        self.label_11.setText(_translate("autoBWF", "CodingHistory"))
        ...
        self.label_14.setText(_translate("autoBWF", "Comment"))
        self.label_8.setText(_translate("autoBWF", "Technician"))
        self.label_15.setText(_translate("autoBWF", "ISFT"))
        self.md5Check.setText(_translate("autoBWF", "Embed MD5 of data chunk"))
        self.label_9.setText(_translate("autoBWF", "Copyright"))
